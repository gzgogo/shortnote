...
var AppPages = [
  { title: '极速笔记', entry: ['notes'], template: path.resolve(AppPaths.src, 'template.html') , fileName: 'notes.html' },
  { title: '极速笔记-注册', entry: ['register'], template: path.resolve(AppPaths.src, 'template.html') , fileName: 'register.html' },
  { title: '极速笔记-登录', entry: ['login'], template: path.resolve(AppPaths.src, 'template.html') , fileName: 'login.html' },
  { title: '极速笔记', entry: ['index'], template: path.resolve(AppPaths.src, 'template.html') , fileName: 'index.html' }
];
...
var config = {
  ...
  plugins: [
    ...
    //     template: path.resolve(AppPaths.src, 'notes.html'),
    //     inject: 'body'
    // })
